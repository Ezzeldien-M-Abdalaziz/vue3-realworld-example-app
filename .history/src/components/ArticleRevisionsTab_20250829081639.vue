...
const fetchRevisions = async () => {
  ...
  try {
    const res = await api.articles.getArticleRevisions(props.articleSlug)
...
const revertRevision = async (revisionId: number) => {
  ...
  try {
    await api.articles.revertArticleRevision(props.articleSlug, revisionId)
    alert('Article reverted successfully!')
    // Emit event to refresh the article
