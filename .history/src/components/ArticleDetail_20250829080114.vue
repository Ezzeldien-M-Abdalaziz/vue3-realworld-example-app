...
export default defineComponent({
  ...
  setup() {
    ...
    const articleId = Number(route.params.id); // assuming ID param
    ...
    const fetchArticle = async () => {
      try {
        const res = await api.articles.getArticle(article.slug);
    ...
    function updateArticle(newArticle: Article) {
      Object.assign(article, newArticle);
         ...
         return { article, articleId, activeTab, articleHandledBody, updateArticle };
  },
});
</script>
